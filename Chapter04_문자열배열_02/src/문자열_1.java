/*	
		...
		String은 클래스 => 메소드 (기능)
		 ...
		 => indexOf() : 지정된 문자 위치값 확인 (문자번호 0번부터)
		 	=> 원형 : int indexOf(char / String s)
		 	
		 => lastIndexOf() : 지정된 문자 위치값 확인 (문자번호, length()-1)
		 	=> 원형 : int lastIndexOf(char / String s)
...
//		System.out.println(a);
		String[] names={"홍길동","박문수","심청이","이순신","강갑찬"};
		//String은 문자저장이 제한이 없음
		/*
		 * 		Stack		Heap
		 * 		names		names[0] names[1] names[2] names[3] names[4]
		 * 		-----		-------------------------------------------
		 * 		100			"홍길동" | "박문수" | "심청이" | "이순신" | "강갑찬"
		 * 		-----		|-------------------------------------------
		 * 				메모리 주소 (100)
		 * 		
		 * 		1. 선언
		 ...
		 */
		// 출력
			for(String name:names) //실제 저장된 값을 가지고옴
			{
...
//			}
			...
			System.out.println(name+"는(은) "+(index+1)+"번쩨 있습니다.");
	}
