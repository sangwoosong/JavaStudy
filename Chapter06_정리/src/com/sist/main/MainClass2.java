...
/*
			...
			- 대규모 프로젝트에 주로 사용
			  ...
			  Spring(MVC) => Front (MVC=>Vuex,Redux)
			  	...
			  	=> 한개의 서버에서 작업 => 서버 점검시에 서비스 중단
			  	   ----------------
			  	   	여러개의 서버로 나눠서 작업 (MSA) => Spring Cloud
			  	   	=> 데이터 분석 => 지능형랩
			  	   		추천
			  	   	new Vue({
			  	   	})
	...
	------------------------------------------
				...
				데이터 활용
					...
					1) 종류
						...
						- 정적메소드
							...
							https://www.google.com/search?q=%EC%9E%90%EB%B0%94&rlz=1C1FHFK_koKR1074KR1074&oq=%EC%9E%90%EB%B0%94&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIGCAEQRRg7MgYIAhBFGDsyBggDEEUYOzITCAQQLhiDARjHARixAxjRAxiABDINCAUQABiDARixAxiABDITCAYQLhiDARjHARixAxjRAxiABDINCAcQABiDARixAxiABDINCAgQABiDARixAxiABNIBCDk3MGowajE1qAIAsAIA&sourceid=chrome&ie=UTF-8
							
							자바 => %EC%9E%90%EB%B0%94 = 인코딩
							%EC%9E%90%EB%B0%94 => 자바 = 디코딩
							
						- 종단메소드 : 오버라이딩이 안되는 메소드 => 사용 빈도 거의 없음
		...
		=>
			...
			상속 : 기존의 기능을 사용
					expends : 확장
						예외) static, 생성자, 초기화블록, private은 접근이 안됨
								final 클래스는 상속 불가
			다형성 : 변경 / 추가
					=> 오버라이딩 / 오버로딩
		-------------------------------------
...
import java.awt.*;
// 오버라이딩(재정의) => 기본(상속) => 속도(상속X => 익명의 클래스를 이용하면 재정의됨)
